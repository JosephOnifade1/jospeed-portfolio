...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $o(e,t,n){let r=new Float32Array(zo),i=new W(0,1,0);return new Na({name:`SphericalGaussianBlur`,defines:{n:zo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function es(){return new Na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ts(){return new Na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ns(),fragmentShader:`
	...
	`}var rs=class extends yn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ha(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}var tu=[{title:`Frontend`,skills:[{name:`React`,level:95},{name:`TypeScript`,level:88},{name:`Tailwind CSS`,level:92}]},{title:`Backend`,skills:[{name:`Node.js`,level:85},{name:`Express`,level:82}]},{title:`Database & Cloud`,skills:[{name:`Supabase`,level:93},{name:`PostgreSQL`,level:84}]},{title:`AI & Automation`,skills:[{name:`n8n`,level:90},{name:`Voiceflow`,level:85},{name:`ManyChat`,level:80}]},{title:`No-code & Builders`,skills:[{name:`Bubble`,level:78},{name:`Adalo`,level:74},{name:`FlutterFlow`,level:72}]},{title:`Server & Hosting`,skills:[{name:`Vercel`,level:90},{name:`Render`,level:84},{name:`Railway`,level:82},{name:`Docker`,level:80}]},{title:`Design & 3D`,skills:[{name:`Blender`,level:78},{name:`Lovable.dev`,level:88}]}];function nu({name:e,level:t,inView:n,delay:r}){return(0,f.jsxs)(`div`,{style:{marginBottom:16},children:[(0,f.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginBottom:6},children:[(0,f.jsx)(`span`,{style:{fontSize:13.5,color:`var(--text)`},children:e}),(0,f.jsxs)(`span`,{style:{fontSize:12,fontFamily:`var(--mono)`,color:`var(--text-faint)`},children:[t,`%`]})]}),(0,f.jsx)(`div`,{style:{height:5,background:`rgba(255,255,255,0.08)`,borderRadius:999,overflow:`hidden`},children:(0,f.jsx)(`div`,{style:{height:`100%`,width:n?`${t}%`:0,background:`linear-gradient(90deg, var(--indigo), var(--cyan))`,borderRadius:999,transition:`width 0.7s cubic-bezier(0.16,1,0.3,1) ${r}s`}})})]})}function ru({group:e,i:t}){let[n,r]=P(.2);return(0,f.jsxs)(`div`,{ref:n,className:`reveal ${r?`in-view`:``}`,style:{transitionDelay:`${t*.08}s`,padding:`22px 20px`,border:`1px solid rgba(129,140,248,0.16)`,borderRadius:18,background:`linear-gradient(135deg, rgba(17,18,28,0.95), rgba(12,14,24,0.82))`,boxShadow:`0 18px 40px -24px rgba(0,0,0,0.7)`,backdropFilter:`blur(8px)`},children:[(0,f.jsx)(`h4`,{style:{fontFamily:`var(--mono)`,fontSize:13,color:`var(--cyan)`,marginBottom:18,textTransform:`uppercase`,letterSpacing:`0.04em`},children:e.title}),e.skills.map((e,t)=>(0,f.jsx)(nu,{...e,inView:r,delay:t*.1},e.name))]})}function iu(){let[e,t]=P();return(0,f.jsxs)(`section`,{id:`skills`,children:[(0,f.jsxs)(`div`,{className:`wrap`,children:[(0,f.jsxs)(`div`,{ref:e,className:`reveal ${t?`in-view`:``}`,style:{marginBottom:48},children:[(0,f.jsx)(`div`,{className:`eyebrow`,children:`// Technical Arsenal`}),(0,f.jsxs)(`h2`,{className:`section-heading ${t?`in-view`:``}`,children:[`The tools behind the build.`,(0,f.jsx)(`span`,{className:`rule`})]})]}),(0,f.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(220px, 1fr))`,gap:24},className:`skills-grid`,children:tu.map((e,t)=>(0,f.jsx)(ru,{group:e,i:t},e.title))})]}),(0,f.jsx)(`style`,{children:`
        @media (max-width: 980px) {
      ...
      `})]})}var au=[{icon:w,name:`Web app development`,desc:`Full-stack apps built with React and Supabase — auth, real-time data and clean deploys.`,price:`From $250`},{icon:E,name:`AI chatbot integration`,desc:`Voiceflow and ManyChat agents that qualify leads and answer customers 24/7.`,price:`From $150`},{icon:re,name:`n8n workflow automation`,desc:`Custom automations connecting your CRM, leads and messaging — no manual work.`,price:`From $120`},{icon:D,name:`3D rendering & design`,desc:`Interactive product configurators and 3D renders built in Blender and Three.js.`,price:`From $200`}];function ou({s:e,i:t}){let[n,r]=P(.15),i=e.icon;return(0,f.jsx)(`div`,{ref:n,className:`reveal ${r?`in-view`:``}`,style:{transitionDelay:`${t*.08}s`},children:(0,f.jsxs)(`div`,{style:{background:`var(--surface)`,border:`1px solid var(--border)`,borderTop:`2px solid var(--indigo)`,borderRadius:12,padding:30,height:`100%`},children:[(0,f.jsx)(`div`,{style:{width:46,height:46,borderRadius:10,background:`rgba(99,102,241,0.1)`,display:`flex`,alignItems:`center`,justifyContent:`center`,marginBottom:20},children:(0,f.jsx)(i,{size:22,color:`var(--indigo-bright)`})}),(0,f.jsx)(`h3`,{style:{fontSize:18,marginBottom:10},children:e.name}),(0,f.jsx)(`p`,{style:{fontSize:14.5,color:`var(--text-dim)`,marginBottom:20,lineHeight:1.6},children:e.desc}),(0,f.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,f.jsx)(`span`,{style:{fontFamily:`var(--mono)`,fontSize:13,color:`var(--text-faint)`},children:e.price}),(0,f.jsxs)(`a`,{href:`#contact`,style:{fontSize:13.5,fontWeight:600,color:`var(--cyan)`,display:`flex`,alignItems:`center`,gap:4},children:[`Get a quote `,(0,f.jsx)(T,{size:14})]})]})]})})}function su(){let[e,t]=P();return(0,f.jsxs)(`section`,{id:`services`,children:[(0,f.jsxs)(`div`,{className:`wrap`,children:[(0,f.jsxs)(`div`,{ref:e,className:`reveal ${t?`in-view`:``}`,style:{marginBottom:40},children:[(0,f.jsx)(`div`,{className:`eyebrow`,children:`// What I Offer`}),(0,f.jsxs)(`h2`,{className:`section-heading ${t?`in-view`:``}`,children:[`Services built around outcomes.`,(0,f.jsx)(`span`,{className:`rule`})]})]}),(0,f.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:22},className:`services-grid`,children:au.map((e,t)=>(0,f.jsx)(ou,{s:e,i:t},e.name))})]}),(0,f.jsx)(`style`,{children:`
        @media (max-width: 640px) {
          .services-grid { grid-template-columns: 1fr !important; }
        }
      `})]})}var cu=[{quote:`Jospeed rebuilt our booking flow in days, not weeks. Communication was async and effortless across time zones.`,name:`Jurre B.`,place:`Netherlands 🇳🇱`,platform:`Via Fiverr`},{quote:`Fast, clean Supabase work and he actually explains decisions instead of just shipping code blindly.`,name:`Kenneth M.`,place:`USA 🇺🇸`,platform:`Via Fiverr`},{quote:`The automation he built saves our team hours every week. Exactly the kind of builder you want on a lean team.`,name:`Raj P.`,place:`UAE 🇦🇪`,platform:`Direct client`}];function lu({t:e,i:t}){let[n,r]=P(.15);return(0,f.jsx)(`div`,{ref:n,className:`reveal ${r?`in-view`:``}`,style:{transitionDelay:`${t*.1}s`},children:(0,f.jsxs)(`div`,{style:{background:`var(--surface)`,border:`1px solid var(--border)`,borderRadius:12,padding:28,height:`100%`,position:`relative`},children:[(0,f.jsx)(te,{size:28,color:`var(--indigo)`,style:{opacity:.3,marginBottom:14}}),(0,f.jsx)(`div`,{style:{display:`flex`,gap:3,marginBottom:14},children:Array.from({length:5}).map((e,t)=>(0,f.jsx)(ne,{size:14,fill:`var(--cyan)`,color:`var(--cyan)`},t))}),(0,f.jsxs)(`p`,{style:{fontSize:15,color:`var(--text)`,lineHeight:1.65,marginBottom:22},children:[`"`,e.quote,`"`]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`div`,{style:{fontWeight:600,fontSize:14.5},children:e.name}),(0,f.jsxs)(`div`,{style:{fontSize:13,color:`var(--text-faint)`},children:[e.place,` · `,e.platform]})]})]})})}function uu(){let[e,t]=P();return(0,f.jsxs)(`section`,{id:`testimonials`,children:[(0,f.jsxs)(`div`,{className:`wrap`,children:[(0,f.jsxs)(`div`,{ref:e,className:`reveal ${t?`in-view`:``}`,style:{marginBottom:40},children:[(0,f.jsx)(`div`,{className:`eyebrow`,children:`// Client Words`}),(0,f.jsxs)(`h2`,{className:`section-heading ${t?`in-view`:``}`,children:[`Trusted across time zones.`,(0,f.jsx)(`span`,{className:`rule`})]})]}),(0,f.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(3, 1fr)`,gap:22},className:`testimonial-grid`,children:cu.map((e,t)=>(0,f.jsx)(lu,{t:e,i:t},e.name))})]}),(0,f.jsx)(`style`,{children:`
        @media (max-width: 860px) {
          .testimonial-grid { grid-template-columns: 1fr !important; }
        }
      `})]})}function du(){let[e,t]=(0,l.useState)(!1),[n,r]=(0,l.useState)(0);return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`div`,{className:`grain`}),(0,f.jsx)(p,{dragActive:e,dragSpeed:n}),(0,f.jsx)(ie,{}),(0,f.jsxs)(`main`,{children:[(0,f.jsx)(Gl,{onSceneDragChange:({active:e,speed:n})=>{t(e),r(n)}}),(0,f.jsx)(Jl,{}),(0,f.jsx)(Xl,{}),(0,f.jsx)(eu,{}),(0,f.jsx)(iu,{}),(0,f.jsx)(su,{}),(0,f.jsx)(uu,{}),(0,f.jsx)(F,{})]})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(du,{})}));